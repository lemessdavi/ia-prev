...
export type ErrorFeedbackOperation =
  ...
  | "loadThread"
  | "loadDossier"
  | "loadConversationAttachmentArchive"
...
const TRANSLATIONS: Record<string, string> = {
  ...
  "You cannot clear messages in this conversation.": "Voce nao pode limpar mensagens nesta conversa.",
  ...
  "Contact profile not found for this contact.": "Perfil do contato nao encontrado para este contato.",
  "Conversation archive not found.": "Arquivo compactado da conversa nao encontrado.",
  "Conversation archive not found": "Arquivo compactado da conversa nao encontrado.",
  ...
  "Falha ao carregar arquivos da conversa.": "Nao foi possivel carregar os arquivos desta conversa.",
  ...
  "Falha ao exportar ZIP de anexos.": "Nao foi possivel exportar o ZIP de anexos.",
  "Falha ao limpar conversa.": "Nao foi possivel limpar o historico da conversa.",
...
export function shouldSuppressErrorFeedback(input: ErrorFeedbackSuppressionInput): boolean {
  const normalizedCode = input.code?.trim().toUpperCase();
  if (
    (input.operation !== "loadDossier" && input.operation !== "loadConversationAttachmentArchive") ||
