...
test("suprime toast quando o arquivo ZIP da conversa ainda nao existe na carga automatica", () => {
  const shouldSuppress = shouldSuppressErrorFeedback({
    code: "NOT_FOUND",
    message: "Conversation archive not found",
    operation: "loadConversationAttachmentArchive",
  });
